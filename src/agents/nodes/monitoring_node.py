"""
Usage monitoring agent node — CPU, memory, disk, running processes.
"""
...
def monitoring_node(state: AgentState, config: RunnableConfig) -> dict:
    ...
    return {
        ...
        # Always set monitoring_result so the supervisor sees a completed result
        "task_context": {"monitoring_result": response or "Task completed."},
    }